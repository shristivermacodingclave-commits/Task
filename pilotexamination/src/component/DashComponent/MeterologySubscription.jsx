...
// import "./MeterologySubscription.css"; // <-- external CSS import
...
//                     )}
//                   </h6>
//                   <span className={`badge`} style={{backgroundColor: plan.saveBg , color:plan.saveColor , borderRadius:"10px"}}>
//                     {plan.saveText}
//                   </span>
//                 </div>
//               </div>
...
//           <form className="mt-4">
//             <div className="row g-3 align-items-center coupon-row my-5"  style={{backgroundColor:"#ffffff", borderRadius:"10px" , padding:"0rem 1rem 1rem 1rem"}}>
...
//               </div>
//               <div className="mt-2" >
//               <p className="small mb-0 fw-semibold" style={{color:"#008000", fontSize:"1.1rem"}}>
