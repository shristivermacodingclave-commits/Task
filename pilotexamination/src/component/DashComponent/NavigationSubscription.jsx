...
//                             <h3 className="card-title my-3">Air Navigation</h3>
...
//                             <div
//                                 className={`plan-card d-flex align-items-center justify-content-between px-4 py-4 my-3 rounded-4 shadow-sm ${selected === plan.id ? "active" : ""
  ...
  const fetchPlanData = async () => {
    try {
      const res = await axios.get(
        "https://development.pilotexaminations.com/api/payment-plans/3"
      );
      ...
      console.error("Error fetching navigation plans:", err);
    }
  };
