...
import AtgImage from '../../assets/images/atgimage.jpeg'
import "./MeterologySubscription.css";
import Loader from "../Loader";

function AtgSubscription() {
  ...
  const fetchPlanData = async () => {
    try {
      const res = await axios.get(
        "https://development.pilotexaminations.com/api/payment-plans/33"
      );
        ...
        <div className="col-md-4">
          <div className="card border-0 shadow-sm rounded-4 h-100">
            ...
            <div className="card-body">
              <h3 className="card-title my-3">Aircraft Technical General (ATG)</h3>
...
export default AtgSubscription;
