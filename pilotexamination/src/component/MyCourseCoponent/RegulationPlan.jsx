...
export default function RegulationPlan() {
    ...
    useEffect(() => {
        axios
            .get("https://development.pilotexaminations.com/api/subject/2")
            .then((res) => {
                if (!res.data.error) {
        ...
        <div className="bg-light min-vh-100 mt-3">
            ...
            <div className="container-fluid pb-3">
                <div className="card border-0 shadow-sm rounded-4 overflow-hidden">
                    ...
                    <div
                        className="py-4"
                        style={{ backgroundColor: subject.title_color || "#fefff2" }}
                    >
                    ...
                    <div
                        className="py-4"
                        style={{
                            backgroundColor: subject.body_color || "#f5f6e2",
                            minHeight: "130px",
                        }}
                    >
                        <div className="container-fluid">
            ...
            <div className="container-fluid">
                <div className="d-flex flex-column gap-3">
                    {topics.map((topic, index) => {
                        const isFree = index === 0; // only first topic free
                        return (
                            <div
                                key={topic.topic_id}
                                className="rounded-2"
                            ...
                            >
                                ...
                                >
                                    <div className="d-flex align-items-center gap-5">
                                        ...
                                        <div className="fs-5 fw-semibold">{topic.topic_name}
