...
export default function PlanPage() {
    ...
    // ⭐ E-TEST navigation → NEW ROUTE: /etest/:topicId
    const handleAttemptForFree = (topicName, topicId) => {
        navigate(`/dashboard/my-courses/etest/${topicId}`, {
            state: {
                type: "e-test",
                subject: subject.subject_name,
                topic: topicName,
    ...
    // ⭐ Mock Test navigation → NEW ROUTE: /mocktest/:subjectId
    const handleMockTest = () => {
        navigate(`/dashboard/my-courses/mocktest/${subject.subject_id}`, {
            state: {
                type: "mock-test",
                subjectId: subject.subject_id,
                subjectName: subject.subject_name,
    ...
    // ⭐ Practice Test navigation → NEW ROUTE: /practice/:miniSubjectId
    const handlePracticeTest = () => {
        navigate(`/dashboard/my-courses/practice/${subject.mini_subject_id || 1}`, {
            state: {
                type: "practice-test",
                miniSubjectId: subject.mini_subject_id || 1,
                topic: subject.mini_subject_name || "Practice Test",
                subject: subject.subject_name,
                planPath: `/dashboard/my-courses/plan/${subject.subject_id}`,
    ...
    return (
        <div className="bg-light min-vh-100 mt-3">
            ...
            {/* NON-PURCHASED: show price section & locked practice */}
            {!isPurchased && (
                <div className="container-fluid my-5">
