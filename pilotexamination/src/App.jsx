...
import useAxiosLoader from "./component/Loader/useAxiosLoader";
import SubjectSubscription from './component/DashComponent/SubjectSubscription.jsx';



// Added to ensure useAxiosLoader runs INSIDE provider
function AxiosLoaderInstaller() {
  useAxiosLoader();
  return null;
}
...
function App() {
  ...
  return (
    <>
      ...
      {/* LoaderProvider moved UP and AxiosLoaderInstaller placed inside */}
      <LoaderProvider>
        <AxiosLoaderInstaller />
        <GlobalLoader />
        ...
        <Routes>
          ...
          <Route path="/dashboard" element={<DashboardLayout />}>
            ...
            <Route path="my-courses" element={<MyCourseLayout />}>
              ...
              <Route path="etest/:topicId" element={<PlanEtest />} />
              <Route path="practice/:miniSubjectId" element={<PlanPracticeTest />} />
              <Route path="mocktest/:mockId" element={<PlanMocktest />} />
            </Route>
          ...
          <Route path="/plans" element={<MainLayout />}>
            ...
            <Route path="enroll_now/:subjectId" element={<SubjectSubscription/>} />
