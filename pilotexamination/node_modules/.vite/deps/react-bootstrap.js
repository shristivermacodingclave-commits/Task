...
var Switch = React66.forwardRef((props, ref) => (0, import_jsx_runtime60.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var Offcanvas = React86.forwardRef(({
  ...
  const renderBackdrop = (0, import_react39.useCallback)((backdropProps) => (0, import_jsx_runtime80.jsx)("div", {
    ...backdropProps,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime97.jsxs)(import_jsx_runtime96.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react46.cloneElement)(children, triggerProps), (0, import_jsx_runtime95.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function createButton(name, defaultValue, label = name) {
  const Button = React99.forwardRef(({
    children,
    ...props
...
var Pagination = React100.forwardRef(({
  ...
  return (0, import_jsx_runtime100.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames75.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames76.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
